...
<div class="modal-window modal-wide">
  <div class="panel panel-small">
    <div class="panel-header"><a class="js-dismiss-modal dismiss-modal"><i class="ion ion-ios-close-outline"></i></a><h3>Aviso de Privacidad</h3></div>
    ...
    <div class="panel-footer"><h6>Copyright</h6></div>
  </div>
</div>
</div>
